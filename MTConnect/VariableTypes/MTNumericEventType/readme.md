...
<!-- end of text -->
The representation of the MTNumericEventType VariableType in the address space is shown in the following table:  
...
|ValueRank|-1|
|IsAbstract|False|
|BaseType|[DataItemType](../../../Core/VariableTypes/DataItemType/readme.md)|
|Categories||

The references from the MTNumericEventType VariableType Node are shown in the following table:  
