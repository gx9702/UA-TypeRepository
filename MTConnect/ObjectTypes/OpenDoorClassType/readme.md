...
<!-- end of text -->
The representation of the OpenDoorClassType ObjectType in the address space is shown in the following table:  
...
The references from the OpenDoorClassType ObjectType Node are shown in the following table:  
