...
<!-- end of text -->
The representation of the OpenChuckClassType ObjectType in the address space is shown in the following table:  
...
The references from the OpenChuckClassType ObjectType Node are shown in the following table:  
