<!-- objecttype -->
## MaterialChangeClassType
  
<!-- end of text -->
The representation of the MaterialChangeClassType ObjectType in the address space is shown in the following table:  
...
The references from the MaterialChangeClassType ObjectType Node are shown in the following table:  
