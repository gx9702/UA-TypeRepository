<!-- objecttype -->
## MaterialLoadClassType
  
<!-- end of text -->
The representation of the MaterialLoadClassType ObjectType in the address space is shown in the following table:  
...
The references from the MaterialLoadClassType ObjectType Node are shown in the following table:  
