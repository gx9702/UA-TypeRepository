...
<!-- end of text -->
The representation of the PartChangeClassType ObjectType in the address space is shown in the following table:  
...
The references from the PartChangeClassType ObjectType Node are shown in the following table:  
